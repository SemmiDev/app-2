...
class MahasiswaService
{
    ...
    public function findByPaginate($limit, $offset) {
        $listMahasiswa = $this->mahasiswaRepository->findAllWithPaginate($limit, $offset);
        $mahasiswaDetails = [];
    ...
    public function search($q) {
        $listMahasiswa = $this->mahasiswaRepository->search($q);
        $mahasiswaDetails = [];
        foreach ($listMahasiswa as $mhs) {
            $m = new MahasiswaEntityDetails(
                $mhs,
